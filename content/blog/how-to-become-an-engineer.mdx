...
- **[Clerk](https://clerk.com)** — Authentication in 20 minutes. Sign up, log in, user management out of the box.
- **[Stripe](https://stripe.com)** — Payments via API. Checkout sessions, subscriptions, invoices — all handled.
