...
// Full article render shared by the dynamic [slug] route and dedicated
// (e.g. password-gated) post routes.
export async function BlogArticle({ post }: { post: BlogPost }) {
  ...
  // Related posts (getAllBlogPosts already excludes gated posts)
